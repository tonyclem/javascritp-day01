...
const bookList = [
  ...
  "Philosophic Naturalism Principal Mathematical",
  "Disquisitions Arithmetical",
];
...
let newerBookList = remove1(
  bookList,
  "On The Electrodynamics of Moving Bodies"
);
let newestBookList = remove1(
  add1(bookList, "A Brief History of Time"),
  "On The Electrodynamics of Moving Bodies"
);
